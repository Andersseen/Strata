...
`new ControllerClass()`, at registration time. Handlers take no arguments; the H3 event is not
exposed. There is no dependency injection, request scope, parameter extraction or non-GET method
yet.
