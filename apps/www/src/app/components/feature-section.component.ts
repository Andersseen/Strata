  ...
  template: `<section id="why" class="feature-section section-wrap">
    ...
    <div class="feature-grid">
      ...
      ><volt-card-header>
        ...
        <volt-card-title>Declarative by default</volt-card-title>
      </volt-card-header><volt-card-content><p>
          Describe routes alongside the code that owns them. Metadata stays inspectable through a
          small public API.
        </p>
      </volt-card-content><volt-card-footer><a href="#example">See a controller <lmn-arrow-right [size]="16" /></a>
      </volt-card-footer></volt-card>
      <volt-card
      ...
      ><volt-card-header>
        ...
        <volt-card-title>Runtime stays yours</volt-card-title>
      </volt-card-header><volt-card-content><p>
          No replacement server, no hidden transport. Register directly on H3—or on Nitro's router
          in Analog.
        </p>
      </volt-card-content><volt-card-footer><a href="#architecture">Explore the boundary <lmn-arrow-right [size]="16" /></a>
      </volt-card-footer></volt-card>
      <volt-card
        class="feature-card"
        [moveInView]="{ opacity: [0, 1], y: [28, 0] }"
